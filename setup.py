    ...
    try:
        with path.open(mode="rt", encoding="utf-8") as fp:
            return list(filter(None,
                               (line.split("#")[0].strip() for line in fp)))
    except IndexError:
...
setup(
    ...
    use_scm_version={
        ...
        "write_to": "tasks/_repo_version.py",
        "write_to_template": 'version = "{version}"\n',
        "relative_to": __file__,
    },
    include_package_data=True,
    package_data={},
    packages=find_packages(where="tasks"),
    package_dir={"": "tasks"},
    classifiers=[
    ...
    author_email="shivammaurya@outlook.com",
    url="https://github.com/mauryas/data_science_product",
)
